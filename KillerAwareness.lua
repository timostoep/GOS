...
SmiteManager = {
	...
	Camps = {
		["monsterCamp_9"] = { names={["sru_blue"]=1}, obj = nil},
		["monsterCamp_15"] = { names={["sru_blue"]=1}, obj = nil},
		["monsterCamp_7"] = { names={["sru_red"]=1}, obj = nil},
		["monsterCamp_16"] = { names={["sru_red"]=1}, obj = nil},
		["monsterCamp_18"] = { names={["sru_dragon_elder"]=1, ["sru_dragon_water"]=1, ["sru_dragon_fire"]=1, ["sru_dragon_earth"]=1, ["sru_dragon_air"]=1, ["sru_dragon_ruined"]=1, ["sru_dragon_chemtech"]=1, ["sru_dragon_hextech"]=1}, obj = nil},
		["monsterCamp_2"] = { names={["sru_gromp"]=1}, obj = nil},
		["monsterCamp_10"] = { names={["sru_gromp"]=1}, obj = nil},
		["monsterCamp_12"] = { names={["sru_murkwolf"]=1}, obj = nil},
		["monsterCamp_17"] = { names={["sru_murkwolf"]=1}, obj = nil},
		["monsterCamp_13"] = { names={["sru_razorbeak"]=1}, obj = nil},
		["monsterCamp_14"] = { names={["sru_razorbeak"]=1}, obj = nil},
		["monsterCamp_5"] = { names={["sru_krug"]=1}, obj = nil},
		["monsterCamp_6"] = { names={["sru_krug"]=1}, obj = nil},
		["monsterCamp_3"] = { names={["sru_riftherald"]=1}, obj = nil},
		["monsterCamp_11"] = { names={["sru_baron"]=1}, obj = nil},
		["monsterCamp_4"] = { names={["sru_horde"]=1}, obj = nil},
		["monsterCamp_1"] = { names={["sru_crab"]=1}, obj = nil},
		["monsterCamp_8"] = { names={["sru_crab"]=1}, obj = nil},
	},
					...
					if(camp.isCampUp and GetDistance(myHero.pos, camp.pos) <= 1200) and v.obj == nil then
						...
						if(#jgMonsters > 0) then
							for _, monster in ipairs(jgMonsters) do
								if(v.names[string.lower(monster.charName)] == 1) then
									v.obj = monster
									scanSuccess = true
									break
								end
		...
		if(Ready(self.SmiteSlot) and not myHero.dead) then
			for k, v in pairs(self.Camps) do
				...
				if(v.obj and not v.obj.dead and v.obj.visible and GetDistance(v.obj.pos, myHero.pos) <= self.SmiteRange) then
					...
					objname = string.lower(v.obj.charName) 
					local key = self.SmiteTable[objname]
			...
			if(Ready(self.SmiteSlot) and IsValid(myHero)) then
				for k, v in pairs(self.Camps) do
					if(v.obj and not v.obj.dead and v.obj.visible and GetDistance(v.obj.pos, myHero.pos) <= 1000) then
						...
						local canDraw = false
						objname = string.lower(v.obj.charName) 
						local key = self.MarkTable[objname]
